    ...
    try {
      ...
      while (turn < MAX_TURNS) {
        ...
        const VERBS = [
          ...
          'Compiling thoughts', 'Reticulating splines', 'Allocating braincells',
          'Herding tokens', 'Milking the API', 'Harvesting answers',
          'Consulting the oracle', 'Summoning wisdom', 'Warming up hamsters',
          'Polishing the crystal ball', 'Asking nicely', 'Feeding the squirrels',
